                ...
                <ul class="list-group list-group-flush rounded-3">
                    <li class="list-group-item d-flex justify-content-between align-items-center m-1 border-0">
                        <span class="d-flex align-items-center">
                            <img src="{{ asset('violation.png') }}" alt="icon" class="me-2"
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center m-1 border-0"
                        ...
                        <span class="fw-bold d-flex align-items-center" style="color: #2c3e50;">
                            <img src="{{ asset('pending.png') }}" alt="icon" class="me-2"
                                style="width: 18px; height: 18px;">
                            Pending
                        </span>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center m-1 border-0"
                        ...
                        <span class="fw-bold d-flex align-items-center" style="color: #2c3e50;">
                            <img src="{{ asset('done.png') }}" alt="icon" class="me-2"
                                style="width: 18px; height: 18px;">
                            Resolved
                        </span>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-footer bg-white border-0 py-3">
                    <div class="row align-items-center">
                        ...
                        <div
                            class="col-12 col-sm-auto ms-auto d-flex justify-content-center justify-content-sm-end">
